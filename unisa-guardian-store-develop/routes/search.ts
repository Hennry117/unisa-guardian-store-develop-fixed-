...
module.exports = function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query(
      'SELECT * FROM Products WHERE ((name LIKE :namePattern OR description LIKE :descriptionPattern) AND deletedAt IS NULL) ORDER BY name',
      {
        replacements: {
          namePattern: `%${criteria}%`,
          descriptionPattern: `%${criteria}%`
        },
